...
<?php $__env->startSection('main'); ?>
    <div class="list_container">
        ...
        <div class="category_container">
                <div class="category_list" id="<?php echo e($categoryName); ?>">
                    <h1><?php echo e($categoryName); ?></h1>
                    <?php $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if( $article->category->name == $categoryName ): ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\myblog\resources\views/articles/list_category.blade.php ENDPATH**/ ?>